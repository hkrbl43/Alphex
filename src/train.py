...
from src.model import Block, Alphex, Config
...
def main() -> None:
    ...
    config = Config.from_name("124M")
    config.block_size = 1024
    config.vocab_size = 50356 
...
def load_datasets(data_dir: str = "data") -> Tuple[np.ndarray, np.ndarray]:
